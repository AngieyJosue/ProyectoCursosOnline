<%-- 
    Document   : education
    Created on : 05-oct-2015, 12:38:44
    Author     : Angelica
--%>
...
<html>
<head>
<title>Duhoot Bootstarp Website Template | Education :: w3layouts</title>
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="../multimedia/imagenes/nav.png" alt="" /></a>
						   <ul class="nav" id="nav">
						    	...
						    	<li class="active"><a href="diplomados.jsp">DIPLOMADOS</a></li>
   	  ...
   	  <div class="container">
   		  <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   		  	<ul class="feature">
                   <li> <i class="icon-trophy"></i></li>
                    <li class="feature_right"><h4>Expert teachers</h4>
                    <p>
            ...
            <ul class="feature">
                   <li> <i class="icon-tick"></i></li>
                    <li class="feature_right"><h4>Trusted Certifications</h4>
                    <p>
                        Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex, appareat similique an usu.
                    </p>
                    </li>
            ...
            <ul class="feature">
                   <li> <i class="icon-audio"></i></li>
                    <li class="feature_right"><h4>Audio Lessons</h4>
                    <p>
                        Lorem ipsum dolor sit amet, vix erat audiam ei. Cum doctus civibus efficiantur in. Nec id tempor imperdiet deterruisset, doctus volumus explicari qui ex, appareat similique an usu.
                    </p>
                    </li>
         ...
         <div class="col-md-8 wow fadeInRight" data-wow-delay="0.4s">
          <div class="educate_grid">
            <div class="col-md-6">
			    ...
			    <img src="../multimedia/imagenes/e4.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">Poetry</span>
			    </span>
				</a>
				<div class="living_desc desc1">
				<h3><a href="#">aliquam volutp</a></h3>
				<p>Lorem ipsum consectetuer adipiscing </p>
				<p class="educate"><img src="../multimedia/imagenes/star1.png" alt=""/></p>
		    ...
		    <div class="col-md-6">
   	    	  <div class="living_box"><a href="#">
			    <img src="../multimedia/imagenes/e3.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">Fundamental</span>
			    </span>
				</a>
				<div class="living_desc desc1">
				<h3><a href="#">aliquam volutp</a></h3>
		   ...
		   <div class="educate_grid1">
            <div class="col-md-6">
   	    	  <div class="living_box"><a href="#">
			    <img src="../multimedia/imagenes/e1.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
		    ...
		    <div class="col-md-6">
   	    	  <div class="living_box"><a href="#">
			    <img src="../multimedia/imagenes/e2.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">Poetry</span>
			    </span>
				</a>
