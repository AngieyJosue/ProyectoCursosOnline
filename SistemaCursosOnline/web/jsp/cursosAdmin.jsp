...
<html>
<head>
<title>Duhoot Bootstarp Website Template | Living :: w3layouts</title>
...
<div class="header">
   ...
   <div class="living_middle">
   	  <div class="container">
   	    ...
   	    <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="#">
				...
				<a href="#" class="waves-effect waves-light btn">Ver Detalle</a>
                                <a href="" class="waves-effect waves-light btn " id="btnSubirImagenes" >Curso</a>
            ...
            <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="#">
				...
				<a href="#" class="btn3">Ver Detalle</a>
                                <a href="" class="btn btn-primary btn-sm btnSubirImagenes" >Curso</a>
				<p class="price">$687,000</p>
				</div>
			    <table border="1" class="propertyDetails">
                <tbody><tr>
		 ...
		 </div><div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="#">
			    <img src="../multimedia/imagenes/l1.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">IDIOMAS</span>
