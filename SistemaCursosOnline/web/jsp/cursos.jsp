...
<body>
    <div class="header">
        ...
        <div class="col-sm-4 header_right">
            <div id="loginContainer"><a href="#" id="loginButton"><img src="../multimedia/imagenes/login.png"><span>Registrarse</span></a>
                <div id="loginBox">                
                    <form id="loginForm">
                        <fieldset id="body">
                                <fieldset>
    ...
    <div class="content_top">
        <div class="container">
            ...
            <div class="col-md-6 filter_grid">
                <ul class="filter">
    ...
    <div class="living_middle">
        <div class="container">
            ...
            <div class="row">
                <!--Inicia el curso 1-->
                <div class="col s12 m6 l4 grey lighten-5">
                    <div class="living_box ">                        
                        ...
                        <table border="1" class="propertyDetails">
                            <tbody>
                                <tr>
                                    <td ><p>Fecha &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Inicio</p><i class="tiny material-icons">today</i>28/10/15</td>
                                    <td ><p>Fecha Finalización</p><i class="tiny material-icons">today</i>28/10/15</td>
                                    <td ><p>Participantes</p><i class="tiny material-icons">supervisor_account</i>3</td>
                                </tr>
                            </tbody>
                        </table>   
