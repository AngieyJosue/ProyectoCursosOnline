<%-- 
    Document   : entertain
    Created on : 06-oct-2015, 19:27:12
    Author     : Angelica
--%>
...
<html>
<head>
<title>Duhoot Bootstarp Website Template | Entertainment :: w3layouts</title>
...
<script src="../javaScript/jquery.swipebox.min.js"></script> 
		   ...
		   <div class="col-sm-8 header-left">
					 ...
					 <div class="menu">
						  ...
						  <ul class="nav" id="nav">
						    	...
						    	<li><a href="diplomados.jsp">DIPLOMADOS</a></li>
						    	<li class="active"><a href="ofertas.jsp">OFERTAS</a></li>
						    	<li><a href="404.jsp">Mobility</a></li>
   ...
   <div class="living_middle">
   	  <div class="container">
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p1.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p1.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p2.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p2.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p3.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p3.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p4.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p4.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		 ...
		 <div class="entertain_box1 wow fadeInRight" data-wow-delay="0.4s">
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p5.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p5.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p6.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p6.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p7.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p7.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
		   ...
		   <div class="col-md-3 grid_box">
		   	   <a href="../multimedia/imagenes/p8.jpg" class="swipebox"  title="Image Title"> <img src="../multimedia/imagenes/p8.jpg" class="img-responsive" alt=""><span class="zoom-icon"></span> </a>
		   	  <div class="grid_box2">
			   <h4><a href="#">Photos</a></h4>
			   <p>20 Photos</p>
	          </div>
   ...
   <div class="living_bottom">
   	  <div class="container">
   	  	...
   	  	<div class="col-md-6 post_left wow fadeInLeft" data-wow-delay="0.4s">
   	  		<div class="mask1"><img src="../multimedia/imagenes/pic4.jpg" alt="image" class="img-responsive zoom-img" /></div>
   	  	...
   	  	<div class="col-md-6 post_left wow fadeInRight" data-wow-delay="0.4s">
   	  		<div class="mask1"><img src="../multimedia/imagenes/pic5.jpg" alt="image" class="img-responsive zoom-img" /></div>
   	  	    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque cursus, sem eget sagittis sagittis, nisl magna sodales eros, ut feugiat velit velit non turpis. Cras eu nibh dapibus justo fringilla   <a href="#">More</a></p>
   	  	    <div class="divider"></div>
   	  	    <p class="field-content">30 Sep 2014</span></p>
   	  	</div>
